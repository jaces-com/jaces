"""Steps transition detector using PELT algorithm."""
...
class StepsTransitionDetector(BasePELTTransitionDetector):
    """
    PELT-based steps transition detector.
    
    Detects statistically significant changes in step count using
    ...
    def __init__(
        ...
        """
        Initialize steps transition detector.
