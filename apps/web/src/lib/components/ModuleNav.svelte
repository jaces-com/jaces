...
<div class="flex h-full w-18 flex-col justify-between bg-neutral-100">
	<div>
		<!-- Jaces Animated Logo -->
		...
		{#each modules as module}
			...
			<!-- svelte-ignore a11y_no_static_element_interactions -->
			<div
				class="group flex cursor-pointer flex-col h-18 items-center justify-center transition-colors hover:bg-neutral-200"
			...
			>
				<div class="mb-1.5 flex size-6 items-center justify-center">
					<iconify-icon
						icon={activeModule === module.id && module.iconFilled
							? module.iconFilled
							: module.icon}
