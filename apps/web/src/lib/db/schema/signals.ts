...
import { check, geometry, index, json, pgTable, real, timestamp, unique, uuid, varchar } from "drizzle-orm/pg-core";
...
export const signals = pgTable(
      "signals",
      {
            ...
            // Idempotency key for safe reprocessing and deduplication
      ...
      (table) => ({
            ...
            idempotencyIdx: index("idx_ambient_signals_idempotency").on(table.idempotencyKey),
